...
def bhr_genebass_variant_to_gene_lof_syn(var_type, upper_bound, lower_bound, name):
    ...
    genebass_gene.entries().export('gs://bhr_ms_gene_ss_400k_final_thin_withnullburden_'+str(var_type)+'_nvar'+str(nvar)+'_low'+str(lower_bound)+'_high'+str(upper_bound)+'_'+str(name)+'.txt.bgz')
