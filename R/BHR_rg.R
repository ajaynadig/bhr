...
BHR_rg <- function(trait1_sumstats, trait2_sumstats, annotations, num_blocks = 100,genomewide_correction = TRUE,overdispersion, num_null_conditions = 0,output_jackknife_rg = FALSE, fixed_genes = NULL) {
  ...
  trait1_sumstats = trait1_sumstats[,c("gene","N","gamma_sq","gamma","w_t_beta","burden_score","burden_score_sqrt","overdispersion","chromosome","gene_position","trait_type")]
  trait1_sumstats$true = TRUE

  trait2_sumstats = trait2_sumstats[,c("gene","N","gamma_sq","gamma","w_t_beta","burden_score","burden_score_sqrt","overdispersion","chromosome","gene_position","trait_type")]
